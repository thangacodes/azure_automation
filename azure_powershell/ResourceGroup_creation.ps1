...
$rgp = Read-Host "Please enter the resource group that you wanted to create:"
Write-Host "The entered ResoruceGroup name is:" -BackgroundColor Black -ForegroundColor Red $rgp
...
New-AzResourceGroup -Name $rgp -Location $place
